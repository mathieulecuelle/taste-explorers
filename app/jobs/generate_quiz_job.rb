          ...
          messages: [
            {
              role: "user",
              content: <<~MESSAGE
                Génère un résumé de 3 lignes maximum mettant en avant l’histoire et la culture associées au plat #{dish.name}. Ensuite, saute une ligne via \n et crée un quiz rapide comprenant 3 questions marrantes (humoristique) avec leurs réponses liées à l’histoire et à la culture de ce plat. Chaque question doit être suivie d’un point-virgule « ; », de 3 réponses possibles séparées par des points-virgules « ; », et de la bonne réponse indiquée entre parenthèses à la fin.
